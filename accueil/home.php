...
<body>
  ...
  <section class="testimonials" id="review">
    ...
    <div class="slider">
      <div class="slide">
        <div class="card">
          <img src="./images/boutoumi.jpg" alt=" Photo client">
          <h3>Bachira Boutoumi</h3>
      ...
      <div class="slide">
        <div class="card">
          <img src="./images/plombier.jpg" alt=" Photo client">
          <h3>Plombier</h3>
          <p>"Service exceptionnel et équipe très professionnelle !"</p>
          <div class="stars">⭐⭐⭐⭐⭐</div>
        </div>
      ...
      <div class="slide">
        <div class="card">
          <img src="./images/leila.jpg" alt=" Photo client">
          <h3>Leila Oukhrani</h3>
